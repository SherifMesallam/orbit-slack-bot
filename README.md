...
| **Remember Information for future reference** | reply `#remember` Store any discussion or information  for future reference.                                                                                                                                                                                                    |
...
| **Save conversation for future reference** | reply `#remember` anywhere in the thread                                                                                                                                                                                                                     |
